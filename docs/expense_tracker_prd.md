...
4. **FR4**: The app displays extracted data alongside original receipt image in side-by-side verification interface allowing user confirmation and editing
...
### Story 2.4: Side-by-Side Verification Interface
As a business traveler,
I want to verify and edit AI-extracted data alongside the receipt image,
so that I can ensure accuracy before saving expenses.

**Acceptance Criteria**
1. Split-screen layout with receipt image on left, editable data fields on right
2. Highlighted extracted fields showing AI confidence levels
3. Quick edit capabilities for all extracted data (merchant, amount, tax, date, category)
4. Visual indicators showing data source (AI service, offline OCR, or manual entry)
5. Save and cancel options with validation for required fields
